...
cp arch/arm/boot/dts/overlays/ddplayer-dac.dtbo ../Drivers/ddplayer-drivers/boot/overlays/ddplayer-dac.dtbo 
cp ../KernelBuild/lib/modules/4.14.88-v7+/kernel/sound/soc/bcm/snd-soc-ddplayer-dac.ko ../Drivers/ddplayer-drivers/lib/modules/4.14.71+/kernel/sound/soc/bcm/
cp ../KernelBuild/lib/modules/4.14.88-v7+/kernel/sound/soc/bcm/snd-soc-ddplayer-dac.ko ../Drivers/ddplayer-drivers/lib/modules/4.14.71-v7+/kernel/sound/soc/bcm/ 
cd ../Drivers/
